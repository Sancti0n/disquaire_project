...
from disquaire_project.secrets import SECRET_KEY
...
#https://docs.djangoproject.com/fr/3.1/howto/static-files/deployment/
...
DATABASES = {
    'default': {
        ...
        'USER': 'myuser', # attention : remplacez par votre nom d'utilisateur
        'PASSWORD': '',
        'HOST': '',
        'PORT': '5432',
